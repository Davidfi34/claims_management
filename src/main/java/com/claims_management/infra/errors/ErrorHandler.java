...
public class ErrorHandler extends GenericRestController {
    ...
    public ResponseEntity<CustomResponse> errorHandlerIntegrity(Exception e){
        return notFound(null,e.getMessage(),null);//ResponseEntity.badRequest().body(e.getMessage());
    }
